...
extension CompoundQuriesTest {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__CompoundQuriesTest = [
...
extension ElasticSwiftTests {
    ...
    static let __allTests__ElasticSwiftTests = [
        ...
        ("test_21_DeleteIndex", test_21_DeleteIndex),
        ("testPlay", testPlay),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        testCase(CompoundQuriesTest.__allTests__CompoundQuriesTest),
